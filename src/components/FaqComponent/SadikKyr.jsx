export const SadikKyr = () => {
    return <>
        <h3 className="faqHeader">Бул жерден сиз бала бакчага тапшырууда суроолоруңузга жооп ала аласыз</h3 >
        <div
        ...
        >
            <div class="accordion-item rounded-top">
                <h2 class="accordion-header" id="flush-headingOne">
                    ...
                    >
                        Мен жаңы колдонуучу атын жана паролду ала аламбы?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        Жаңы логин жана паролду алуу үчүн жакынкы райондук борборго кайрылуу керек
                        билим берүү же Кыргыз Республикасынын Билим берүү жана илим министрлигинин райондук билим берүү жана илим бөлүмү.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingtwo">
                    ...
                    >
                        Менин каттоо дарегим жок. Биз эмне кылышыбыз керек?
                    </button>
                </h2>
                <div
                    id="flush-collapse13"
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Каттоо дареги жок болсо. Даректи тактоо үчүн жакынкы КБКга кайрылуу керек.
                            Эгерде сиз үй ээси болсоңуз, анда сиз менен кошо ала кетиңиз:
                        </p>
                        ...
                        <p className="third__title_text">
                            Эгерде сиз турак жайдын ээси болбосоңуз, сиз жашаган дарегиңиз боюнча каттоого арыз менен кайрылыңыз
                            мүлктүн ээси жеке өзү болушу керек. Сиз менен бар:
                        </p>
                        <ol className="row gy-3">
                            <li>
                                Паспорт
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingthree">
                    ...
                    >
                        Мурда тапшырып, бала бакчага кезекке турсаңыз, азыр
                        бул кезек бузулбайбы же жылбайбы?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Эгерде сиз буга чейин balabakcha.edu.gov.kg системасы аркылуу арыз берген болсоңуз, анда кезек өз ордунда калат.
                        </p>
                        <p className="third__title_text">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingfoure">
                    ...
                    >
                        Билдирүүнү алгандан кийин, арыз ээси ДООго төмөнкү документтерди берүүгө милдеттүү
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Билдирүүнү алгандан кийин, арыз ээси ДООго төмөнкү документтерди тапшырышы керек:
                        </p>
                        <ol className="row gy-2">
                            ...
                            <li>
                                баланын туулгандыгы тууралуу күбөлүктүн көчүрмөсү;
                            </li>
                            <li>
                                Ата-энесинин биринин (мыйзамдуу өкүлдөрүнүн) паспортунун көчүрмөсү;
                            </li>
                            <li>
                                № 26/У, № 063/У толтурулган медициналык формалар;
                            </li>
                            <li>
                                окууга кабыл алуу учурунда баланын ден соолугу жөнүндө маалымкат;
                            </li>
                            <li>
                                Зарыл болгон учурда республикалык же шаардык психологиялык-медициналык-педагогикалык корутунду
                                корректировкалоону аяктагандыгына байланыштуу баланы мектепке чейинки билим берүү мекемелеринин жалпы өнүктүрүү тобуна берүү боюнча комиссия.
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingfive">
                    ...
                    >
                        Бала үчүн орун төмөнкү учурларда сакталат
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Балага орун төмөнкү учурларда сакталат:
                        </p>
                        <ol className="row gy-2">
                            <li>
                                узак карантинди сактоо зарылчылыгы менен бала ооруган учурда;
                            </li>
                            <li>
                                санаториялык-курорттук дарыланууда (милдеттүү түрдө медициналык корутунду берүү менен);
                            </li>
                            <li>
                                ата-энелик өргүү (45 календардык күндөн ашык эмес) же ата-энесинин узак мөөнөттүү иш сапарында;
                            </li>
                            <li>
                                ата-энесинин арызы боюнча үй-бүлөлүк жагдайларга байланыштуу башка иштер (45 календардык күндөн ашпаган мөөнөт).
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingsixe">
                    ...
                    >
                        Бир эле учурда эки бала бакчага тапшырсам болобу?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Бир гана бала бакчага тапшыра аласыз.
                        </p>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingseven">
                    ...
                    >
                        Мен пайданын түрүн кошо аламбы?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Сиз өзүңүздүн жеке кабинетиңиздеги арызга жеңилдиктер сертификатын кошуу үчүн өзгөртө аласыз.
                            Бул үчүн сиз ата-эненин эсебине кирүү баскычын чыкылдатуу менен кирүү керек.
                        </p>
                        <p className="third__title_text">
                            <b>Маанилүү!</b> Эгерде сиз арызды каттоодо туура эмес электрондук почта дарегин киргизсеңиз,
                            Кыргыз Республикасынын Билим берүү жана илим министрлигинин жакынкы аймактык билим берүү борборуна кайрылууңуз керек.
                        </p>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingeight">
                    ...
                    >
                        Эртерээк тапшырып, бала бакчага кезекке турсам,
                        эми бул кезек бузулбайбы же жылдырылбайбы?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Эгерде сиз буга чейин balabakcha.edu.gov.kg системасы аркылуу арыз берген болсоңуз, анда кезек өз ордунда калат.
                            Жөлөк пул алуу үчүн арыздардын эсебинен кезектин бир аз жылышы мүмкүн.
                        </p>
                        <p className="third__title_text">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingnine">
                    ...
                    >
                        balabakcha.edu.gov.kg сайтынан арызды бул сайтка которууда,
                        жеке кабинеттен логин жана пароль ошол бойдон кала береби?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Жок, сиз "Ата-энелер кабинетине" барып, "Сырсөздү унутуп калдым" баскычын чыкылдатып, сырсөзүңүздү калыбына келтиришиңиз керек,
                            электрондук почта дарегин киргизүү менен, ал жаңы сырсөз менен билдирүү алат.
                        </p>
                        <p className="third__title_text">
                            Эгерде сиз өзүңүздүн электрондук почтаңызды билбесеңиз же эсиңизде жок болсоңуз, анда "Электрондук почтаңызды унутуп калдыңыз" баскычын басышыңыз керек.
                            жана керектүү талааларды толтуруп, сиз электрондук почтаны таба аласыз.
                        </p>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingten">
                    ...
                    >
                        Мен жөлөкпулдардын түрлөрүнүн бирине ылайыктуумун, пособиелерди алуу тартиби кандай?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Арыз берүү учурунда сиз тиешелүү жөлөкпулду тандап, тастыктаган документти тиркөөңүз керек
                            пайдасын айтты
                            (файл .PDF форматында жана 3 МБдан чоң эмес болушу керек).
                            Жөлөкпулдун түрү жана тастыктоочу документти түзөтүү ата-эненин жеке кабинетинде мүмкүн.
                        </p>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingeleven">
                    ...
                    >
                        Эгерде мен бала бакчага тапшырсам, балам окууга кирип калса, бирок мен өлкөдөн чыгып кетишим керек
                        бала менен. Мен эмне кылышым керек?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Сиз ата-энеңиздин жеке аккаунтуна кирип, "ӨТКӨНҮ ЖОК КОЮУ" баскычын басуу менен арызыңызды жокко чыгарышыңыз керек.
                        </p>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingtwelfe">
                    ...
                    >
                        КР ӨКМнин РКОнун байланыш маалыматтары жана даректери
                    </button>
                </h2>
                <div
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingthirty">
                    ...
                    >
                        Бала бакчаны кантип алмаштыруу керек?
                    </button>
                </h2>
                <div
                ...
                >
                    <div class="accordion-body text__accordion__body">
                        <p className="third__title_text">
                            Өтүнмөнү жокко чыгаруу үчүн "Ата-эненин жеке кабинетине" өтүү керек, бөлүмдү тандаңыз
                            "Тиркемелер" / зарыл болгон учурда тиркеме ачылгандан кийин "Илеп белгиси" баскычын басыңыз
                            баскычын чыкылдатуу "Бакчаны өзгөртүү"
                        </p>
                        <p className="third__title_text">
                            <b>МААНИЛҮҮ!!!</b>
                        </p>
