...
export const ShkolaRus = () => {
  return <>
    <h3 className="faqHeader">Здесь Вы можете получить ответы на интересующие Вас вопросы при подачи заявки в школу</h3 >
    <div
    ...
    >
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingThree">
          ...
          >
            А если моему ребенку исполнилось уже 8-9 лет, можем ли мы пойти в
            школу?
          </button>
        </h2>
        <div
      ...
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body text__accordion__body">
            ...
            о зачислении Вашего ребенка, если да, то это уже процедура
            перевода из школы в школу и нет необходимости заново вставать в
            очередь. Если приказа нет, то Вам необходимо написать заявление в
            МОН КР.
          </div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body text__accordion__body">
            ...
            ></iframe>
            <p className="third__title_text">КАК ПОДАТЬ ЗАЯВЛЕНИЕ?</p>
            <p className="third__title_text">
              Для подачи заявления заполните последовательно следующие
              сведения:
            </p>
            <ol className="row gy-3">
              <li>
                Укажите, кем вы приходитесь ребенку?
                <ul>
                  <li>Отец;</li>
                  <li>Мать;</li>
                  <li>
                    Законный представитель (при выборе этого пункта требуется
                    прикрепить соответствующий документ)
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>Гражданство;</li>
                  <li>
                    Персональный идентификационный номер (ПИН), ФИО,
                    паспортные данные (серия, номер);
                  </li>
                  <li>Номер мобильного телефона;</li>
                  <li>
                    Основная электронная почта (куда поступает логин и
                    пароль);
                  </li>
                  <li>
                    Дополнительная электронная почта (Электронные почты служат
                    для восстановления учетной записи);
                  </li>
                  <li>
                    Имеется/Не имеется льгота (при выборе этого пункта
                    требуется прикрепить соответствующий документ).
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    Персональный идентификационный номер (ПИН), ФИО, дата
                    рождения, пол ребенка;
                  </li>
              ...
              <li>
                Выбор школы:
                <p className="third__title_text">По первому этапу:</p>
                <ul>
                  <li>Желаемый язык обучения;</li>
                  <li>
                    По адресу прописки родителей в системе автоматически
                    отображается соответствующая школа.
                  </li>
                </ul>
                <p className="third__title_text">По второму этапу:</p>
                <ul>
                  <li>Желаемый язык обучения;</li>
                  <li>Область/город;</li>
                  <li>
                    Заявитель может выбирать любую школу, при наличии
                    свободных мест.
                  </li>
                </ul>
              </li>
              <li>
                Просмотр заполненных сведений перед подачей заявления:{" "}
                <ul>
                  <li>
                    Перед подачей заявления требуется проверить на
                    правильность заполненные в заявлении сведения
                  </li>
                  <li>
                    После подтверждения Вашего заявления Вам будет направлено
                    на Ваш электронные почты уведомление об успешной подаче
                    заявления для зачисления в школу.
                  </li>
                </ul>
              </li>
            </ol>
        ...
        >
          <div class="accordion-body text__accordion__body">
            <p>
              ...
              собственником жилья, при себе иметь:
            </p>
            <ol>
              <li>Паспорт;</li>
            ...
            <p>
              ...
              заявление о регистрации Вас по адресу проживания должен владелец
              жилья при личном присутствии. При себе иметь:
            </p>
            <ol>
              <li>Паспорт;</li>
            ...
            <p>
              Для получения дополнительной информации обращаться по следующим
              номерам:
            </p>
            <ul>
