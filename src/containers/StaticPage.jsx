...
export const StaticPage = () => {
  ...
  return (
    <>
              ...
              <div className="accordion" id="accordionExample">
                <div className="accordion-item rounded-3">
                  <h2 className="accordion-header" id="headingOne">
                    <button
                      className="w-100 btn rounded__only__top__custom accordion-button padding__button__custom text-start btn border-primary border border-1 w-100"
                      type="button"
                  ...
                  >
                    <div className="accordion-body p-0">
                      <ul className="w-100 rounded-0 p-0 m-0">
                        <li className="btn btn-primary text-white w-100 rounded-0 px-0">
                          <button
                            type="button"
                        ...
                        <li className="btn w-100 rounded-0 px-0">
                          <button
                            type="button"
                            className="w-100 text-start btn"
                          >
                        ...
                        <li className="btn w-100 rounded-0 px-0">
                          ...
                          >
                            <img src="DD" alt="" />
                            <span className="ms-2">Другие учреждения</span>
                          </button>
                        </li>
                      </ul>
                    </div>
      ...
      <section>
        <div className="container">
          <h4 className="third__title__text">
            Фильтр для точечного поиска учреждения
          </h4>
          <form className="form form-cotrol">
            <div className="row row-cols-1 row-cols-lg-3 gy-4 d-none d-md-flex">
              <div className="col-12 col-lg-4">
                ...
                <select className="form-select border border-1 border-primary">
              ...
              <div className="col-12 col-lg-4">
                <label className="form-label">
                  Класс, курс (в зависимости от учреждения)
                </label>
                <select className="form-select border border-1 border-primary">
                  <option selected disabled>
                    Государственный
            ...
            <div className="row row-cols-1 row-cols-lg-3 gy-5 d-none d-lg-block pt-5">
              <div className="col-12 col-lg-4">
                <label className="form-label"></label>
                <button className="btn btn-primary text-center w-100">
                  <img src={search} />
                  <span className="ms-2">Найти</span>
                </button>
              </div>
            </div>
                    ...
                    <div className="accordion-body gy-4 row">
                      ...
                      <div className="col-12 w-100">
                        <button className="btn btn-primary text-center w-100">
                          ...
                          <span className="buttons__text">Найти</span>
                        </button>
                      </div>
                    </div>
                  </div>
